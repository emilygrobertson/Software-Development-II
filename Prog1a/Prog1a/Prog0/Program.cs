...
public class Program
{
    ...
    public static void LateFee(List<LibraryItem> items)
    {
        WriteLine(book1.ToString());
        WriteLine("Estimation on your books being a week overdue");
        displayLateFee = book1.CalcLateFee(10);
        WriteLine($"{displayLateFee.ToString("C")}");
    }
