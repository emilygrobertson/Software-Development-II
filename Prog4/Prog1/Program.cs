...
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        //This will output the original list of items
        Console.Out.WriteLine("Orginal list:");
        foreach (LibraryItem item in items)
            Console.WriteLine($"{item}\n");
        Pause();

        //This will output the list of items in ascending order by Title
        WriteLine("List of Items in Ascending Order by Title: \n");
        items.Sort();
        foreach (LibraryItem item in items)
            WriteLine($"{item}\n");
        Pause();

        //This will output the list of items in descending order by Copyright year
        items.Sort(new DescendingOrder()); // Sort - uses specified Comparer class
        Console.Out.WriteLine("List of Items in Descending Order by Copyright Year: \n");
        foreach (LibraryItem item in items)
            Console.WriteLine($"{item}\n");
        Pause();

        //This will output the list of items in ascending order by Type and Title
        items.Sort(new Sort()); // Sort - uses specified Comparer class
        Console.Out.WriteLine("List of Items in Ascending Order by Type and Title: \n");
        foreach (LibraryItem item in items)
            Console.WriteLine($"{item}\n");
        Pause();
    }
